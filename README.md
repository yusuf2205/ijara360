...
[Отчёт production-релиза M2 от 26 сентября 2026](docs/M2-RELEASE.md): сохранены 7 комнат/56 мест, Backend 36/36, Playwright 14/14, проверка перезапуска и восстановления backup. M3 начинается только отдельным заданием.
